    ...
    <h1>Mediterreian Look</h1>
     <div className={lookStyles.container}>
      ...
      <Image
                    ...
                    src={products[number] === undefined ? products[0].image : products[number].image }
                    width="500"
                    height="500"
                    alt="Picture of the author"
                    priority
      ...
      <h4>{products[number] === undefined ? products[0].name : products[number].name}</h4>
      <p>{products[number] === undefined ? products[0].price : products[number].price}$</p>
      </div>
